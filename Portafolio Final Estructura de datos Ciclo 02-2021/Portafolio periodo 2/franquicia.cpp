//JOSE HUMBERTO HERNANDEZ SOLORZANO HS100301
...
int busquedaBinaria(array<string, SIZE> &arr, string valor) { // Implemente la función búsqueda binaria, para devolver el índice en // el que se encuentra el valor o -1 si este no existe en el arreglo }
void buscarFranquicia() {
string franquicia;
int posicion;
cin.clear();
